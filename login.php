    ...
    <?php } else { ?>
      <div class="container" style="position: relative; padding-top: 5%;">
        ...
        <h2 class="text-center fs-1 fw-bold" style="color:#2682ab">
          Welcome to MeMe-Book
        </h2>
        <p class="text-center fs-3" style="color: #2682ab;">
          Not registerd with us? <br> Get your free account now
        </p>
        <div class="col-form-label-lg text-center">
          <div class="row mb-3">
            <form class="form needs-validation" id="validate_form" action="registration.php" method="post" novalidate>
              ...
              <div class="col-3 mx-auto">
                <label for="colFormLabelSm" class="col-sm-2 col-form-label col-form-label-sm">Email ID</label>
